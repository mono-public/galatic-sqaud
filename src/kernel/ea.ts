...
export const EventAggregator = DI.createInterface<EventAggregator>(
  x => x.singleton(EventAggregatorImpl)
);

/**
 * Enables loosely coupled publish/subscribe messaging.
 */
export interface EventAggregator extends EventAggregatorImpl {}

/**
 * Enables loosely coupled publish/subscribe messaging.
 */
export class EventAggregatorImpl {
  private readonly eventLookup: Record<string, ((message: unknown, channel: string) => void)[]> = {};
  private readonly messageHandlers: Handler<Constructable>[] = [];
